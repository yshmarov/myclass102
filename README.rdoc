...
heroku rename myclass110

git push heroku master

heroku run rake db:migrate

heroku pg:reset DATABASE --confirm myclass110
...
rails destroy scaffold events
rails g bootstrap:themed AttendanceRates


/rails g scaffold ProductType name
/rails g scaffold Product product_type_id:integer/product_category_id:integer name event_quantity:integer event_length:integer member_price:float client_price:float gtype ctype is_active:boolean
...
/rails g scaffold MemberProfile member:belongs_to tenant:belongs_to tel1 tel2 address dob.....

/rails generate devise Client
/add to migration:::::::::: tenant:belongs_to first_name last_name.....
...
/rails g scaffold Attr1 name
/rails g scaffold Attr2 name
/rails g scaffold Attr3 name
