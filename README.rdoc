...
/rails g scaffold Product title(category) event_quantity:integer event_length:integer member_price:float client_price:float gtype ctype is_active:boolean
