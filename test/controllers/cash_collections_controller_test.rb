...
class CashCollectionsControllerTest < ActionController::TestCase
  ...
  test "should create cash_collection" do
    assert_difference('CashCollection.count') do
      post :create, cash_collection: { amount: @cash_collection.amount, office_id: @cash_collection.office_id, tenant_id: @cash_collection.tenant_id }
    end
  ...
  test "should update cash_collection" do
    patch :update, id: @cash_collection, cash_collection: { amount: @cash_collection.amount, office_id: @cash_collection.office_id, tenant_id: @cash_collection.tenant_id }
    assert_redirected_to cash_collection_path(assigns(:cash_collection))
  end
