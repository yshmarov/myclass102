...
class ExpencesControllerTest < ActionController::TestCase
  ...
  test "should create expence" do
    assert_difference('Expence.count') do
      post :create, expence: { amount: @expence.amount, member_id: @expence.member_id, tenant_id: @expence.tenant_id }
    end
  ...
  test "should update expence" do
    patch :update, id: @expence, expence: { amount: @expence.amount, member_id: @expence.member_id, tenant_id: @expence.tenant_id }
    assert_redirected_to expence_path(assigns(:expence))
  end
