...
class AttendanceRatesControllerTest < ActionController::TestCase
  ...
  test "should create attendance_rate" do
    assert_difference('AttendanceRate.count') do
      post :create, attendance_rate: { name: @attendance_rate.name, rate: @attendance_rate.rate, tenant_id: @attendance_rate.tenant_id }
    end
  ...
  test "should update attendance_rate" do
    patch :update, id: @attendance_rate, attendance_rate: { name: @attendance_rate.name, rate: @attendance_rate.rate, tenant_id: @attendance_rate.tenant_id }
    assert_redirected_to attendance_rate_path(assigns(:attendance_rate))
  end
